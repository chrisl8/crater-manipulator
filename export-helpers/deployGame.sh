...
# Use my own icons
cp "${PROJECT_PATH}/export-helpers/web/icons/android-chrome-512x512.png" "${GAME_NAME}.icon.png"
cp "${PROJECT_PATH}/export-helpers/web/icons/apple-touch-icon.png" "${GAME_NAME}.apple-touch-icon.png"
